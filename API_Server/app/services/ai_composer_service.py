    ...
    def _build_system_prompt(
        ...
        *,
        ...
        return (
            ...
            "clarify_questions and leave proposed_dag null. When the "
            "<skills> block below covers an unknown field, FRAME the "
            "question as a binary choice with the skill's value as the "
            "default — e.g. 'Use #finance from your team's policy, or "
            "specify a different channel?'. Cite the skill so the user "
            "sees where the option comes from.\n"
