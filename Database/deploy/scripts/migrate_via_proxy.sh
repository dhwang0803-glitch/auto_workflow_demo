...
#
# Usage:
#   Database/deploy/scripts/migrate_via_proxy.sh <environment> [proxy-port] [migrate.py args...]
#
# Examples:
#   Database/deploy/scripts/migrate_via_proxy.sh prod              # apply
#   Database/deploy/scripts/migrate_via_proxy.sh prod 15432 --status
#
# Defaults:
...
TF_DIR="${REPO_ROOT}/Database/deploy/terraform"
